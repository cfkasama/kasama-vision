...
export function Pill({ children, color="gray" }:{ children:React.ReactNode; color?: "gray"|"gold"|"green" }) {
  const map = { gray:"bg-gray-100 text-gray-700", gold:"bg-yellow-100 text-yellow-800", green:"bg-green-100 text-green-800" } as const;
